    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form action="{{ route('register.store') }}" method="POST">
                ...
                <button type="submit" class="w-full bg-indigo-600 text-white py-2 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Registrar</button>
                <a href="{{ route('login.index') }}" class="block mt-4 text-sm text-gray-500 hover:text-gray-700 text-center">Já tem uma conta? Faça login</a>
            </form>
        </div>
    </div>
</body>
